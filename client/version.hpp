...
#define MMO_VERSION_REVISION 2 Alpha 2
...
#define MMO_VERSION_TITLE "MMO 39chan Fork"
...
#define MMO_VERSION_TEXT_LOADING (MMO_VERSION_TITLE " " MMO_VERSION_TOSTRING(MMO_VERSION_MAJOR) "." \
							MMO_VERSION_TOSTRING(MMO_VERSION_MINOR) "." MMO_VERSION_TOSTRING(MMO_VERSION_REVISION)\
							"  Loading...")
